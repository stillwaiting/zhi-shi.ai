...
! подошел *к кому?* к коту – [дательный]({ссылка-сущ-пад-дат}). {правило-ссылка-дат}
...
! вижу *что?* цветок – [винительный]({ссылка-сущ-пад-вин}). {правило-ссылка-вин}
...
! ударить *чем?* палкой – [творительный]({ссылка-сущ-пад-тв}). {правило-ссылка-тв}
...
! думаю *о чем?* об обеде – [предложный]({ссылка-сущ-пад-пр}). {правило-ссылка-пр}
...
! "кавалерия" {объяснение}

?вопрос об организаци(И|Е) экскурси(И|Е) 
! "организация" {объяснение}
! "экскурсия" — [существительное]({ссылка-сущ}), заканчивается на "-ия" и стоит в [родительном падеже]({ссылка-сущ-пад-род}), поэтому пишется "и". {правило-ссылка-ия-род}

##### Task 2 ий пред

? рассказывается в киносценари(И|Е)
!"киносценарий" — [существительное]({ссылка-сущ}), заканчивается на "-ий" и стоит в [предложном падеже]({ссылка-сущ-пад-пр}), поэтому пишется "и". {правило-ссылка-ий-пред}
...
! [существительное]({ссылка-сущ}) "планетарий" заканчивается на "-ий" и стоит в [предложном падеже]({ссылка-сущ-пад-пр}), поэтому пишется "и". {правило-ссылка-ий-пред}
! [существительное]({ссылка-сущ}) "лекция" заканчивается на "-ия" и стоит в [предложном падеже]({ссылка-сущ-пад-пр}), поэтому пишется "и" {правило-ссылка-ия-пред}.
! [существительное]({ссылка-сущ}) "астрономия" заканчивается на "-ия" и стоит в [дательном падеже]({ссылка-сущ-пад-дат}), поэтому пишется "и".
